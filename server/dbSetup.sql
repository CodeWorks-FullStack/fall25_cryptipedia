...
CREATE TABLE
  cryptids (
    ...
    threat_level TINYINT UNSIGNED NOT NULL CHECK (threat_level <= 10),
    size TINYINT UNSIGNED NOT NULL CHECK (size <= 10),
    img_url VARCHAR(1000) NOT NULL,
    origin ENUM ('terrestrial', 'flying', 'aquatic', 'hominid') NOT NULL,
    description VARCHAR(5000) NOT NULL,
    discoverer_id VARCHAR(255),
